...
class Temperature extends StatefulWidget {
  ...
  final List<Temp> Temps ;
  const Temperature({required this.Temps});
...
late bool _isLoading=true;
                      ...
                      children: <Widget>[
                            ...
                            child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  ClipRRect(
                                    ...
                                    child: Image.asset("images/temper.jpg",
                        ...
                        Container(
                          ...
                          child:(
                             ...
                             ListView(
                                children: [
                                  for (int i = 0; i < widget.Temps.length; i++)
                                    Card(
                                    child: ListTile(
                                      title: Row(
                                          mainAxisAlignment:
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(""+widget.Temps[i].date_add_temp),
                                    ),SizedBox(
                                              width: 7,
                                            ),
                                            Icon(
                                      ...
                                      onTap: () {
                                        ...
                                        Fluttertoast.showToast(
                                            msg: " Temperature : "+widget.Temps[i].val_temp ,
                        ...
                        Container(
                          ...
                          child: FutureBuilder(
                              ...
                              builder:
                                ...
                                if (_isLoading == true)
                                  return new charts.PieChart(dataList(widget.Temps),
                                      animate: true,
  ...
  static List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData(
    ...
    for (int i = 0; i < apiData.length; i++)
      listt.add(new TimeSeriesSales(
           DateTime.parse(apiData[i].date_add_temp), double.parse(apiData[i].val_temp)));
    print(listt[1].temp);
    return [
  ...
  static List<charts.Series<LinearSales, String>> dataList(
    ...
    for (int i = 0; i < apiDatat.length; i++)
      {
      list.add(new LinearSales(i+1,double.parse( apiDatat[i].val_temp)));
  }
    return [
